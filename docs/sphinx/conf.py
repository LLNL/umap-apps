#############################################################################
# This file is part of umap-apps.
#
# For copyright information see the COPYRIGHT file in the top level directory,
# or at https://github.com/LLNL/umap-apps/blob/master/COPYRIGHT. This program is
...
breathe_default_project = "umap-apps"
...
man_pages = [
    (master_doc, 'umap', u'umap-apps Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'umap-apps', u'umap-apps Documentation',
     author, 'umap-apps', 'One line description of project.',
     'Miscellaneous'),
]
